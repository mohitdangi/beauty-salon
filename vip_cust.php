	...
	<!-- end banner -->
	 <section class="ftco-section ftco-pricing">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
            <h2 class="mb-4"> Vip Customers list</h2>
          </div>
        </div>
...
<br>
<h3>Please bring your VIP Confirmation Card to get discount.....Without VIP card you will not get any discount......!Thank You.......!!!!!</h3>
          </div>
        </div>
      </div>
    </div>
