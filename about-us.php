            ...
            <div id="salon" class="page section desktop">
                ...
                <div class="container">
                    ...
                    <div class="sixteen columns py-5">
                        ...
                        <center>
                            <h1 class="display-1"><span style="color: deeppink" >CHIC </span>BEAUTY SALON</h1>
                        </center>

                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <img alt="" class="scale-with-grid salonImage one-third column" src="img/cosmetics.jpg"> </div>

                        <div class="col-md-4">
                            <img alt="" class="scale-with-grid salonImage one-third column" src="img/salon-interior.jpg"> </div>

                        <div class="col-md-4">
   
                            <img alt="" class="scale-with-grid salonImage one-third column" src="img/massage-room.jpg">
                        </div>
                    </div>
...
?>
                        ...
                        <div class="introtext">
                            ...
                            <p><strong style="float:left; color: red; margin-left: -100px; font-size: 20px"><?php  echo $row['PageTitle'];?></strong></p>
