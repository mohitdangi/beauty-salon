...
<head>
    <title>Chic Beauty Salon | Admin Dashboard</title>
...
<style>
   /* #page-wrapper {
    background: url("https://img.freepik.com/free-photo/top-view-assortment-make-up-beauty-products_23-2148620013.jpg?w=1060&t=st=1692338747~exp=1692339347~hmac=867bdb0d4acd32196f228ab116fec6aef71350be8c7d64b6d1b63b6b71895c7d") no-repeat;
   object-fit:cover;
  } */
  #page-wrapper{
...
?>
                        ...
                        <div class="col-md-4 widget states-last">
                            <?php $query6=mysqli_query($con,"Select * from  tbloffers");
$totaloffer=mysqli_num_rows($query6);
?>
                            <div class="stats-left">
                                <h5>Total</h5>
                                <h4>Offers</h4>
                            ...
                            <div class="stats-right">
                                <label> <?php echo $totaloffer;?></label>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
...
?>
                         ...
                         <div class="col-md-4 widget states-last">
                            <?php $query9=mysqli_query($con,"Select * from feedback");
$totalfeed=mysqli_num_rows($query9);
?>
                            <div class="stats-left ">
                                <h5>Total</h5>
                                <h4>Feedback</h4>
                            ...
                            <div class="stats-right">
                                <label> <?php echo $totalfeed;?></label>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
