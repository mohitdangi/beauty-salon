...
if (strlen($_SESSION['bpmsaid']==0)) {
  header('location:logout.php');
	...
	if(isset($_POST['submit'])){
	   ...
	   if ($run_sql) {
	   	echo "<script> alert('Category added into database') </script>";
...
<html>
<head>
<title>Chic Beauty Salon | Add Category</title>
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form action="<?php echo $_SERVER['PHP_SELF'] ;?>" method="post">
    							...
    							<input name="name" type="text" class="form-control" id="category_name" placeholder="product name" required><br>
